...
void	DIO_voidSetPortDirection(u8 PortID , u8 Direction)
{
	if(PortID <4){
		switch(PortID){
			case PORTA:
						for(int i=0;i<8;i++){
							DIO_voidSetPinDirection(PORTA,i,Direction);
						}
						break;
			case PORTB:
						for(int i=0;i<8;i++){
							DIO_voidSetPinDirection(PORTB,i,Direction);
						}
						break;
			case PORTC:
						for(int i=0;i<8;i++){
							DIO_voidSetPinDirection(PORTC,i,Direction);
						}
						break;
			case PORTD:
						for(int i=0;i<8;i++){
							DIO_voidSetPinDirection(PORTD,i,Direction);
						}
						break;
		}
	}
...
void	DIO_voidSetPortValue(u8 PortID , u8 Value){
	...
	if(PortID <4){
		switch(PortID){
			case PORTA:
						for(int i=0;i<8;i++){
							DIO_voidSetPinValue(PORTA,i,Value);
						}
						break;
			case PORTB:
						for(int i=0;i<8;i++){
							DIO_voidSetPinValue(PORTB,i,Value);
						}
						break;
			case PORTC:
						for(int i=0;i<8;i++){
							DIO_voidSetPinValue(PORTC,i,Value);
						}
						break;
			case PORTD:
						for(int i=0;i<8;i++){
							DIO_voidSetPinValue(PORTD,i,Value);
						}
						break;
		}
	}
